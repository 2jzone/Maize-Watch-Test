...
const SOIL_PH_COLORS = {
  ...
  min: "#A78BFA", // Light Purple
  max: "#5B21B6", // Dark Purple
  critical: "#DC2626", // Red
    ...
    return (
      <div className="bg-white border border-gray-200 rounded-lg p-3 shadow-lg">
        ...
        <div className="mt-2 text-xs text-gray-500">
          <p>Thresholds:</p>
          <p className="text-[#A78BFA]">Min: {threshold.min}</p>
          <p className="text-[#5B21B6]">Max: {threshold.max}</p>
          <p className="text-[#DC2626]">Critical: {threshold.critical}</p>
        </div>
      </div>
    );
  }
          ...
          {viewType === "line" ? (
            <LineChart data={chartData}>
              ...
              <Line 
                ...
                strokeWidth={2}
                dot={{ fill: SOIL_PH_COLORS.primary, strokeWidth: 2, r: 4 }}
              />
              <ReferenceLine
